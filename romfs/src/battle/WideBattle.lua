...
function WideBattle.draw(battle)
  ...
  -- per-section draw profile (seconds): pics/HUD/anim/text, same scheme as
  -- drawClassic's flat path, so whichever layout runs, the C++ slow-frame
  -- line gets the battle section breakdown.
  ...
  local t4 = gt()
  battle:noteBattleDraw(t1 - t0, t2 - t1, t3 - t2, t4 - t3)
