...
-- Stereoscopic 3D: dialogue boxes float in FRONT of whatever screen is
-- beneath them (the 3D overworld, a title, a flat menu) -- a box at the
-- screen plane would sit BEHIND the world's popping sprites.  Same game-px
-- scale as the overworld/battle layers; reset to 0 when the box finishes.
local PARALLAX_TEXT = 0.6
...
function TextBox:draw()
  ...
  love.graphics._parallax = PARALLAX_TEXT
